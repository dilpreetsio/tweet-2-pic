  ...
  return (
    <div className="container mx-auto">
      ...
      <div className="flex flex-col items-center">
        ...
        <div ref={tweetCanvas} className="w-fit flex flex-col justify-content items-center bg-gradient-to-r from-cyan-500 to-indigo-500">
          <Tweet id={tweet || DEFAULT} className="p-20"/>
        </div>
        <button type="button" onClick={exportImage}
        className="mt-20 text-white bg-black hover:bg-green-700 focus:outline-none focus:ring-4 focus:ring-green-400
